...
# This code is licensed under the Apache 2.0 License per Scott Dick's Kessler Game Development guide available on the Kessler
# public repo at https://github.com/ThalesGroup/kessler-game
